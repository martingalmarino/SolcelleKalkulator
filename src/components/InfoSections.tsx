      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-16">
          ...
          <div>
            ...
            <div className="space-y-6">
              {benefits.map((benefit, index) => (
                <div 
                  key={index}
                  className="group flex items-start gap-4 p-6 bg-white rounded-2xl border border-gray-100 hover:border-blue-200 hover:shadow-lg transition-all duration-300"
                >
          ...
          <div>
              ...
              {steps.map((step, index) => (
                ...
                >
                  ...
                  {index < steps.length - 1 && (
                    <div className="absolute left-6 top-16 w-0.5 h-8 bg-gray-200 group-hover:bg-blue-300 transition-colors duration-300"></div>
                  )}
            ...
            {/* CTA */}
            <div className="mt-12 p-8 bg-gradient-to-br from-blue-50 to-green-50 rounded-3xl border border-blue-200">
